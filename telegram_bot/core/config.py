...
class Config:
    ...
    def __post_init__(self):
        ...
        self.MAIN_USER_TEXT: str = "gtfdgdg"
        """
        self.MAIN_USER_TEXT: str = (
            ...
            "Быстрый старт: Жми «🎮 Карты» → выбирай карту → изучай фишки или создай свою!\n\n"
            "Время прокачаться! Создавай свою базу знаний и делился мощью. 💪"
        )
        """
