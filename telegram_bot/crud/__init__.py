...
from telegram_bot.crud.cards import (sql_get_cards_by_category, sql_get_card_by_id, sql_add_card,
                                         sql_add_card_image, sql_get_card_image_by_id, sql_get_card_by_number)
from telegram_bot.crud.users import (sql_add_or_update_user, sql_get_user_info, sql_update_and_get_stats_user,
                                         sql_chek_favorite_card_for_user, sql_update_favorite_card_for_user)